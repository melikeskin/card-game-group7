...
public class deneme extends javax.swing.JFrame {
    ...
    public void switchToViewCards()
    {
        mainMenu.setVisible(false);
        if(viewDeckMenu == null)
        {
            viewDeckMenu = new ViewDeckMenu();
            add(viewDeckMenu, BorderLayout.CENTER);
            pack();
        }
        viewDeckMenu.setVisible(true);
